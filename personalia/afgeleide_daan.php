...
<body>
<header>
    <h1 class="pagina_titel"><a href="../index.php"> <img src="../media/images/hyves_logo.png"
    ...
    <div class="breadcrumb">
        ...
        <a href="/afgeleide_daan_pagina.html">Afgeleide Daan</a>
    </div>
</header>
<main>
    <div class="pagina_inhoud">
        <img src="../media/images/pictures_1000px/afgeleide_daan_1000px.jpg" alt="een foto van een afgeleide Daan">
        <p class="textfield">Hier wordt ik gefotografeerd terwijl ik het niet helemaal door had.</p>
    </div>
</main>
<footer>
